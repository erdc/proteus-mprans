...
if useOnlyVF:
    coefficients = Dissipation.Coefficients(V_model=0,ME_model=3,LS_model=None,RD_model=None,kappa_model=2,
    ...
    coefficients = Dissipation.Coefficients(V_model=0,ME_model=6,LS_model=2,RD_model=3,kappa_model=5,
                                        useMetrics=useMetrics,
                                        rho_0=rho_0,nu_0=nu_0,
                                        rho_1=rho_1,nu_1=nu_1,
                                        g=g,
...
dissipationInflow = coefficients.c_mu*kInflow**(1.5)/(0.03*L[2])
