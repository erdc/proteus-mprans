...
#                 boundaryTags['obstacle']]
    ...
    domain = beachBakhtyar3dDomain.beachBakhtyar3d(L)
    #go ahead and add a boundary tags member 
    domain.boundaryTags = boundaryTags
    domain.writePoly("beachBakhtyar")
    domain.writePLY("beachBakhtyar")
    domain.writeAsymptote("beachBakhtyar")
