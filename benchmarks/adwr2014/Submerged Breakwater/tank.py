...
# 2D Submerged Breakwater on a slope
# Waves over barrier
# According to the experiments of Jie et al.(2010)
# Characteristics of flow field and wave propagation
# Hybrid VOF-LS is used for tracking the free surface

#General information for flow feild
...
#  Free surface and turbulence models
...
# ShockCapturingFactor is very important
...
# Wave velocities and water surface
# 2D-Cross-shore 
