...
# 2D Spilling breaker on a slope
# Wave breaking and shoaling
# According to the experiments of Ting and Kirby(19946)
...
inflowVelocityMean = (0.0,0.0)# Still water depth in offshore 
period = 2
...
# Free surface tracking- VOF or hybrid LS-VOF
...
# Change shockCapturingFactor based on mesh size
...
# 2D Cross-shore  
# Waves are perpendicular to the shoreline
