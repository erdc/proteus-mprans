...
PURPOSE:  This Python script is designed to set up and initalize the wave
          field via a JONSWAP spectrum and directional distribution
          function, as input for simulating linear, weakly and fully nonlinear
...
# Imposing iniitial filter (same as Trulsen's et al. for mNLS if filter==1)
if JS.filter == 1:
