...
from proteus.mprans import RDLS#V2
if useRDLS:
...
if rd_freezeLS:
    if LevelModelType == RDLS.LevelModel:#V2.OneLevelRDLSV2:
        weakDirichletConditions = {0:RDLS.setZeroLSweakDirichletBCs}#{0:RDLSV2.setZeroLSweakDirichletBCs}
    else:
