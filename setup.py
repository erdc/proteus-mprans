...
setup(name='proteus_mprans',
      ...
      ext_modules=[Extension('cRANS2PV2',
                   ...
                   Extension('cMCorrV2',
                             ...
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension("cNCLS",["mprans/cNCLS.pyx"],depends=["mprans/NCLS.h"], language="c++",include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   ...
                   Extension("cRANS2P",["mprans/cRANS2P.pyx"],
		             depends=["mprans/RANS2P.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'],
			     language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cRANS2P2",["mprans/cRANS2P2.pyx"],
		             depends=["mprans/RANS2P2.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),                 
		   Extension("cRBLES",["mprans/cRBLES.pyx"],
		             depends=["mprans/RBLES.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'],
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVRANS2P",["mprans/cVRANS2P.pyx"],
		             depends=["mprans/VRANS2P.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cRDLS",["mprans/cRDLS.pyx"],
		             depends=["mprans/RDLS.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVOF",["mprans/cVOF.pyx"],
		             depends=["mprans/VOF.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVolumeAveragedVOF",["mprans/cVolumeAveragedVOF.pyx"],
		             depends=["mprans/VolumeAveragedVOF.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cMoveMesh",["mprans/cMoveMesh.pyx"],
		             depends=["mprans/MoveMesh.h","mprans/ModelFactory.h",os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/src']),
                   ],
      requires=['numpy']
