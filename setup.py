...
setup(name='proteus_mprans',
      ...
      ext_modules=[Extension('cRANS2PV2',
                             ['src/cRANS2PV2Module.cpp','src/RANS2PV2.cpp'],
                   ...
                   Extension('cNCLSV2',
                             ['src/cNCLSV2Module.cpp','src/NCLSV2.cpp'],
                             ...
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('cVOFV2',
                             ['src/cVOFV2Module.cpp','src/VOFV2.cpp'],
                             define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H),('VRANS',1)],
                             include_dirs=[numpy.get_include(),PROTEUS_INCLUDE_DIR,os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src',
                                           PROTEUS_SUPERLU_INCLUDE_DIR],
                             libraries=['m'],
                             ...
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('cRDLSV2',
                             ['src/cRDLSV2Module.cpp','src/RDLSV2.cpp'],
                             define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H)],
                             include_dirs=[numpy.get_include(),PROTEUS_INCLUDE_DIR,os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src',
                                           PROTEUS_SUPERLU_INCLUDE_DIR],
                             libraries=['m'],
                             ...
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('cMCorrV2',
                             ['src/cMCorrV2Module.cpp','src/MCorrV2.cpp'],
                             define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H)],
                             include_dirs=[numpy.get_include(),PROTEUS_INCLUDE_DIR,os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src',
                                           PROTEUS_SUPERLU_INCLUDE_DIR],
                             libraries=['m'],
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension("cNCLS",["src/cNCLS.pyx"],depends=["src/NCLS.h"], language="c++",include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
			     ...
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cRANS2P2",["src/cRANS2P2.pyx"],
		             depends=["src/RANS2P2.h",os.getenv('PROTEUS')+'/proteusModule/include/ModelFactory.h',os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),                 
		   Extension("cRBLES",["src/cRBLES.pyx"],
		             depends=["src/RBLES.h",os.getenv('PROTEUS')+'/proteusModule/include/ModelFactory.h',os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'],
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVRANS2P",["src/cVRANS2P.pyx"],
		             depends=["src/VRANS2P.h",os.getenv('PROTEUS')+'/proteusModule/include/ModelFactory.h',os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
			     ...
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVOF",["src/cVOF.pyx"],
		             ...
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
                   Extension("cVolumeAveragedVOF",["src/cVolumeAveragedVOF.pyx"],
		             depends=["src/VolumeAveragedVOF.h",os.getenv('PROTEUS')+'/proteusModule/include/ModelFactory.h',os.getenv('PROTEUS')+'/proteusModule/src/CompKernel.h'], 
		             language="c++",
			     include_dirs=[numpy.get_include(),os.getenv('PROTEUS')+'/proteusModule/include',os.getenv('PROTEUS')+'/proteusModule/src']),
