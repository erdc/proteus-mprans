...
cdef extern from "RANS2P2.h" namespace "proteus":
    cdef cppclass RANS2P2_base:
    ...
    RANS2P2_base* newRANS2P2(int nSpaceIn,
...
cdef class cRANS2P2_base:
   cdef RANS2P2_base* thisptr
   def __cinit__(self,
                 int nSpaceIn,
                 int nQuadraturePoints_elementIn,
                 int nDOF_mesh_trial_elementIn,
                 ...
                 int nQuadraturePoints_elementBoundaryIn,
                 int CompKernelFlag):
       self.thisptr = newRANS2P2(nSpaceIn,
