...
cdef extern from "RBLES.h" namespace "proteus":
    cdef cppclass RBLES_base:
    ...
    RBLES_base* newRBLES(int nSpaceIn,
...
cdef class cRBLES_base:
   cdef RBLES_base* thisptr
   def __cinit__(self,
                 int nSpaceIn,
                 int nQuadraturePoints_elementIn,
                 int nDOF_mesh_trial_elementIn,
                 ...
                 int nQuadraturePoints_elementBoundaryIn,
                 int CompKernelFlag):
       self.thisptr = newRBLES(nSpaceIn,
