...
cdef extern from "VRANS2P.h" namespace "proteus":
    cdef cppclass VRANS2P_base:
...
# VRANS end
    ...
    VRANS2P_base* newVRANS2P(int nSpaceIn,
...
cdef class cVRANS2P_base:
   cdef VRANS2P_base* thisptr
   def __cinit__(self,
                 int nSpaceIn,
                 int nQuadraturePoints_elementIn,
                 int nDOF_mesh_trial_elementIn,
                 ...
                 int nQuadraturePoints_elementBoundaryIn,
                 int CompKernelFlag):
       self.thisptr = newVRANS2P(nSpaceIn,
