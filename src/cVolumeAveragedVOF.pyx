...
cdef extern from "VolumeAveragedVOF.h" namespace "proteus":
    cdef cppclass VolumeAveragedVOF_base:
    ...
    VolumeAveragedVOF_base* newVolumeAveragedVOF(int nSpaceIn,
...
cdef class cVolumeAveragedVOF_base:
   cdef VolumeAveragedVOF_base* thisptr
   def __cinit__(self,
                 int nSpaceIn,
                 int nQuadraturePoints_elementIn,
                 int nDOF_mesh_trial_elementIn,
                 ...
                 int nQuadraturePoints_elementBoundaryIn,
                 int CompKernelFlag):
       self.thisptr = newVolumeAveragedVOF(nSpaceIn,
