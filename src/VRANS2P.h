...
namespace proteus
{
  ...
  class VRANS2P : public VRANS2P_base
  {
  public:
    ...
    // void calculateVelocityAverage_VRANS2P(int* permutations,
    // 				    int nExteriorElementBoundaries_global,
    // 				    int* exteriorElementBoundariesArray,
  ...
  inline VRANS2P_base* newVRANS2P(int nSpaceIn,
				...
				int CompKernelFlag)
  {
    return proteus::chooseAndAllocateDiscretization<VRANS2P_base,VRANS2P,CompKernel>(nSpaceIn,
