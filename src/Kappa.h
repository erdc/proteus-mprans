...
namespace proteus
{
  ...
  inline Kappa_base* newKappa(int nSpaceIn,
				...
				int CompKernelFlag)
  {
    return proteus::chooseAndAllocateDiscretization<Kappa_base,Kappa,CompKernel>(nSpaceIn,
