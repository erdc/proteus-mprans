...
cdef extern from "RANS3PSed.h" namespace "proteus":
    cdef cppclass RANS3PSed_base:
    ...
    RANS3PSed_base* newRANS3PSed(int nSpaceIn,
...
cdef class cRANS3PSed_base:
   cdef RANS3PSed_base* thisptr
   def __cinit__(self,
                 int nSpaceIn,
                 int nQuadraturePoints_elementIn,
                 int nDOF_mesh_trial_elementIn,
